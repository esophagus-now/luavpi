//STOLEN from: https://github.com/yne/vcd/blob/master/vcd.c
// What a cool piece of code! And so easy to use! 5/5 stars!
//
// (This would be a pretty cool IOCCC entry if I obfuscated it...)
// 
#include <ctype.h>
